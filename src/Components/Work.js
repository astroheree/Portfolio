...
function Work({ position, company, location, type, duration , works }) {
  return (
    <article className="pt-8 border-b-2 border-dark-content pb-5 dark:border-light-content border-opacity-20 dark:border-opacity-20">
      ...
      <div className="mt-4"><p className="text-content text-xs md:text-sm font-light pl-1 min-w-fit">{works}</p></div>
    </article>
  );
}
